...
export default function RecruiterPage() {
  ...
  const handleSimulate = async () => {
    ...
    setLoading(true)
    try {
      // Flow expects a data URI, so we'll encode our text as a base64 plain text file for this simulation
      const base64Resume = Buffer.from(resumeText).toString('base64')
      const resumeDataUri = `data:text/plain;base64,${base64Resume}`
